...
public class DataStorage {
    ...
    /**
     * Adds or updates patient data in the storage. If the patient does not exist, a new Patient object is created and added to
    ...
    /**
     * The main method for the DataStorage class. Initializes the system, reads data into storage, and continuously monitors
